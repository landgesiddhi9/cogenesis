  ...
  return (
    <section className="editorial-section section-media" id="editorial-section">
      <div className="editorial-section__grid grid grid-cols-1 md:grid-cols-2 h-full">
        ...
        <div
          ref={leftRef}
          className={`bg-ivory flex flex-col h-full min-h-0 transition-all duration-1000 ${
            leftInView
        ...
        <div
          ref={rightRef}
          className={`bg-ivory flex h-full min-h-0 overflow-hidden transition-all duration-1000 delay-200 ${
            rightInView
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-10"
          }`}
